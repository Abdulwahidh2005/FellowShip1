...
export function FlowSection({ children, className, style, ariaLabel }) {
  return (
    <section
      data-flow-section
    ...
    >
      <div
        data-flow-inner
        className="flow-art-container relative w-full will-change-transform"
...
export default function FlowArt({ children, className, ariaLabel = 'Story scroll' }) {
